...
function promedioResultadosTest(resultadosTest) {
  ...
  // Tu código:
  return (
    resultadosTest.reduce((acumulador, puntaje) => acumulador + puntaje, 0) /
...
function multiplicarArgumentos() {
  ...
  // return arguments.length === 0 ? 0 : arguments.length === 1 ? arguments[0]: arguments.reduce((contador, numero) => contador * numero, 1)
}
...
function todosIguales(arreglo) {
  ...
  //Escribe tu código aquí
  let iguales = arreglo.every((elemento) => elemento === arreglo[0]);
  return iguales;
}
